...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrivateApi', function() {
      ...
      describe('v1PrivateForecastAccuracySymbolIntervalPeriodGet', function() {
        it('should call v1PrivateForecastAccuracySymbolIntervalPeriodGet successfully', function(done) {
          // TODO: uncomment, update parameter values for v1PrivateForecastAccuracySymbolIntervalPeriodGet call and complete the assertions
          /*
          var symbol = "btc";
          var interval = "1h";
          var period = "7d";
          ...
          instance.v1PrivateForecastAccuracySymbolIntervalPeriodGet(symbol, interval, period, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(CryptoWeather.PrivateForecastAccuracyResponse);
            expect(data.success).to.be.a('boolean');
            expect(data.success).to.be(false);
            expect(data.code).to.be.a('number');
            expect(data.code).to.be(0);
            expect(data.status).to.be.a('string');
            expect(data.status).to.be("");
            expect(data.data).to.be.a(CryptoWeather.PrivateForecastAccuracyResponseData);
                  expect(data.data.accuracy).to.be.a('number');
              expect(data.data.accuracy).to.be();
            {
              let dataCtr = data.errors;
              expect(dataCtr).to.be.an(Array);
              expect(dataCtr).to.not.be.empty();
