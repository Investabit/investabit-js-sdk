...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InvestabitApi.PublicApi();
  });
  ...
  describe('PublicApi', function() {
    ...
    describe('v1PublicPriceHistorySymbolGet', function() {
      it('should call v1PublicPriceHistorySymbolGet successfully', function(done) {
        //uncomment below and update the code to test v1PublicPriceHistorySymbolGet
        //instance.v1PublicPriceHistorySymbolGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
