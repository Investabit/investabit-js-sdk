...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrivateForecastResponse', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PrivateForecastResponse();
      });

      it('should create an instance of PrivateForecastResponse', function() {
        // TODO: update the code to test PrivateForecastResponse
        expect(instance).to.be.a(CryptoWeather.PrivateForecastResponse);
      });
