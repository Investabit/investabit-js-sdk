...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicPriceChangeResponseDataPriceChange', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PublicPriceChangeResponseDataPriceChange();
      });

      it('should create an instance of PublicPriceChangeResponseDataPriceChange', function() {
        // TODO: update the code to test PublicPriceChangeResponseDataPriceChange
        expect(instance).to.be.a(CryptoWeather.PublicPriceChangeResponseDataPriceChange);
      });
