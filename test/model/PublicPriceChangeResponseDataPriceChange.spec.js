...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Investabit.PublicPriceChangeResponseDataPriceChange();
  });
  ...
  describe('PublicPriceChangeResponseDataPriceChange', function() {
    it('should create an instance of PublicPriceChangeResponseDataPriceChange', function() {
      // uncomment below and update the code to test PublicPriceChangeResponseDataPriceChange
      //var instance = new Investabit.PublicPriceChangeResponseDataPriceChange();
      //expect(instance).to.be.a(Investabit.PublicPriceChangeResponseDataPriceChange);
    });
