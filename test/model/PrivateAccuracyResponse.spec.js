...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrivateAccuracyResponse', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PrivateAccuracyResponse();
      });

      it('should create an instance of PrivateAccuracyResponse', function() {
        // TODO: update the code to test PrivateAccuracyResponse
        expect(instance).to.be.a(CryptoWeather.PrivateAccuracyResponse);
      });
