...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicTrendResponseDataTrend', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PublicTrendResponseDataTrend();
      });

      it('should create an instance of PublicTrendResponseDataTrend', function() {
        // TODO: update the code to test PublicTrendResponseDataTrend
        expect(instance).to.be.a(CryptoWeather.PublicTrendResponseDataTrend);
      });
