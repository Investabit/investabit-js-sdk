...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InvestabitApi.PublicTrendResponseDataTrend();
  });
  ...
  describe('PublicTrendResponseDataTrend', function() {
    it('should create an instance of PublicTrendResponseDataTrend', function() {
      ...
      //var instance = new InvestabitApi.PublicTrendResponseDataTrend();
      //expect(instance).to.be.a(InvestabitApi.PublicTrendResponseDataTrend);
    });
