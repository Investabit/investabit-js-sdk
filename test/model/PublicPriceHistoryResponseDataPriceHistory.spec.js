...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicPriceHistoryResponseDataPriceHistory', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PublicPriceHistoryResponseDataPriceHistory();
      });

      it('should create an instance of PublicPriceHistoryResponseDataPriceHistory', function() {
        // TODO: update the code to test PublicPriceHistoryResponseDataPriceHistory
        expect(instance).to.be.a(CryptoWeather.PublicPriceHistoryResponseDataPriceHistory);
      });
