...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicSymbolsResponse', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PublicSymbolsResponse();
      });

      it('should create an instance of PublicSymbolsResponse', function() {
        // TODO: update the code to test PublicSymbolsResponse
        expect(instance).to.be.a(CryptoWeather.PublicSymbolsResponse);
      });
