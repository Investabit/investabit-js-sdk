...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicPriceHistoryResponse', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PublicPriceHistoryResponse();
      });

      it('should create an instance of PublicPriceHistoryResponse', function() {
        // TODO: update the code to test PublicPriceHistoryResponse
        expect(instance).to.be.a(CryptoWeather.PublicPriceHistoryResponse);
      });
