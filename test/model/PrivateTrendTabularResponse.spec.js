...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrivateTrendTabularResponse', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PrivateTrendTabularResponse();
      });

      it('should create an instance of PrivateTrendTabularResponse', function() {
        // TODO: update the code to test PrivateTrendTabularResponse
        expect(instance).to.be.a(CryptoWeather.PrivateTrendTabularResponse);
      });
