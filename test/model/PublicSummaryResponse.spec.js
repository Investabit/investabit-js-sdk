...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PublicSummaryResponse', function() {
      beforeEach(function() {
        instance = new CryptoWeather.PublicSummaryResponse();
      });

      it('should create an instance of PublicSummaryResponse', function() {
        // TODO: update the code to test PublicSummaryResponse
        expect(instance).to.be.a(CryptoWeather.PublicSummaryResponse);
      });
