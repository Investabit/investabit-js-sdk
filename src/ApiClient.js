...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CryptoWeather.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.cryptoweather.ai
     */
    this.basePath = 'https://api.cryptoweather.ai'.replace(/\/+$/, '');
