...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DefaultResponse', 'model/PublicPriceChangeResponse', 'model/PublicPriceCurrentResponse', 'model/PublicPriceHistoryResponse', 'model/PublicSymbolsResponse', 'model/PublicTrendResponse', 'model/PublicWaitingListRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DefaultResponse'), require('../model/PublicPriceChangeResponse'), require('../model/PublicPriceCurrentResponse'), require('../model/PublicPriceHistoryResponse'), require('../model/PublicSymbolsResponse'), require('../model/PublicTrendResponse'), require('../model/PublicWaitingListRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.Investabit) {
      root.Investabit = {};
    }
    root.Investabit.PublicApi = factory(root.Investabit.ApiClient, root.Investabit.DefaultResponse, root.Investabit.PublicPriceChangeResponse, root.Investabit.PublicPriceCurrentResponse, root.Investabit.PublicPriceHistoryResponse, root.Investabit.PublicSymbolsResponse, root.Investabit.PublicTrendResponse, root.Investabit.PublicWaitingListRequest);
  }
}(this, function(ApiClient, DefaultResponse, PublicPriceChangeResponse, PublicPriceCurrentResponse, PublicPriceHistoryResponse, PublicSymbolsResponse, PublicTrendResponse, PublicWaitingListRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the v1PublicWaitingListPost operation.
     * @callback module:api/PublicApi~v1PublicWaitingListPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DefaultResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/PublicWaitingListRequest} opts.body 
     * @param {module:api/PublicApi~v1PublicWaitingListPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/DefaultResponse}
     */
    this.v1PublicWaitingListPost = function(opts, callback) {
      opts = opts || {};
