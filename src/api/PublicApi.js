...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DefaultResponse', 'model/PublicCurrentResponse', 'model/PublicPriceChangeResponse', 'model/PublicPriceHistoryResponse', 'model/PublicSymbolsResponse', 'model/PublicTrendResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DefaultResponse'), require('../model/PublicCurrentResponse'), require('../model/PublicPriceChangeResponse'), require('../model/PublicPriceHistoryResponse'), require('../model/PublicSymbolsResponse'), require('../model/PublicTrendResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Investabit) {
      root.Investabit = {};
    }
    root.Investabit.PublicApi = factory(root.Investabit.ApiClient, root.Investabit.DefaultResponse, root.Investabit.PublicCurrentResponse, root.Investabit.PublicPriceChangeResponse, root.Investabit.PublicPriceHistoryResponse, root.Investabit.PublicSymbolsResponse, root.Investabit.PublicTrendResponse);
  }
}(this, function(ApiClient, DefaultResponse, PublicCurrentResponse, PublicPriceChangeResponse, PublicPriceHistoryResponse, PublicSymbolsResponse, PublicTrendResponse) {
  'use strict';
