...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DefaultResponse', 'model/PrivateAccuracyResponse', 'model/PrivateForecastResponse', 'model/PrivateForecastTimeResponse', 'model/PrivateTrendTabularResponse', 'model/PublicTrendResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DefaultResponse'), require('../model/PrivateAccuracyResponse'), require('../model/PrivateForecastResponse'), require('../model/PrivateForecastTimeResponse'), require('../model/PrivateTrendTabularResponse'), require('../model/PublicTrendResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.CryptoWeather) {
      root.CryptoWeather = {};
    }
    root.CryptoWeather.PrivateApi = factory(root.CryptoWeather.ApiClient, root.CryptoWeather.DefaultResponse, root.CryptoWeather.PrivateAccuracyResponse, root.CryptoWeather.PrivateForecastResponse, root.CryptoWeather.PrivateForecastTimeResponse, root.CryptoWeather.PrivateTrendTabularResponse, root.CryptoWeather.PublicTrendResponse);
  }
}(this, function(ApiClient, DefaultResponse, PrivateAccuracyResponse, PrivateForecastResponse, PrivateForecastTimeResponse, PrivateTrendTabularResponse, PublicTrendResponse) {
  'use strict';
