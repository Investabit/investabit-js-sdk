...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DefaultResponse', 'model/PrivateAccuracyResponse', 'model/PrivateForecastAccuracyResponse', 'model/PrivateForecastResponse', 'model/PrivateForecastTimeResponse', 'model/PrivateTrendTabularResponse', 'model/PublicTrendResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DefaultResponse'), require('../model/PrivateAccuracyResponse'), require('../model/PrivateForecastAccuracyResponse'), require('../model/PrivateForecastResponse'), require('../model/PrivateForecastTimeResponse'), require('../model/PrivateTrendTabularResponse'), require('../model/PublicTrendResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.CryptoWeather) {
      root.CryptoWeather = {};
    }
    root.CryptoWeather.PrivateApi = factory(root.CryptoWeather.ApiClient, root.CryptoWeather.DefaultResponse, root.CryptoWeather.PrivateAccuracyResponse, root.CryptoWeather.PrivateForecastAccuracyResponse, root.CryptoWeather.PrivateForecastResponse, root.CryptoWeather.PrivateForecastTimeResponse, root.CryptoWeather.PrivateTrendTabularResponse, root.CryptoWeather.PublicTrendResponse);
  }
}(this, function(ApiClient, DefaultResponse, PrivateAccuracyResponse, PrivateForecastAccuracyResponse, PrivateForecastResponse, PrivateForecastTimeResponse, PrivateTrendTabularResponse, PublicTrendResponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the v1PrivateForecastAccuracySymbolIntervalPeriodGet operation.
     * @callback module:api/PrivateApi~v1PrivateForecastAccuracySymbolIntervalPeriodGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PrivateForecastAccuracyResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} symbol The cryptocurrency symbol.
     * @param {String} interval The forecast interval, 1h or 1d.
     * @param {String} period The period for computing the error bounds, typically 7d or 30d.
     * @param {Object} opts Optional parameters
     * @param {String} opts.cookie e.g. csrf=b1820141-1bad-4a9c-93c0-52022817ce89
     * @param {String} opts.xCsrf e.g. b1820141-1bad-4a9c-93c0-52022817ce89
     * @param {module:api/PrivateApi~v1PrivateForecastAccuracySymbolIntervalPeriodGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PrivateForecastAccuracyResponse}
     */
    this.v1PrivateForecastAccuracySymbolIntervalPeriodGet = function(symbol, interval, period, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'symbol' is set
      if (symbol === undefined || symbol === null) {
        throw new Error("Missing the required parameter 'symbol' when calling v1PrivateForecastAccuracySymbolIntervalPeriodGet");
      }

      // verify the required parameter 'interval' is set
      if (interval === undefined || interval === null) {
        throw new Error("Missing the required parameter 'interval' when calling v1PrivateForecastAccuracySymbolIntervalPeriodGet");
      }

      // verify the required parameter 'period' is set
      if (period === undefined || period === null) {
        throw new Error("Missing the required parameter 'period' when calling v1PrivateForecastAccuracySymbolIntervalPeriodGet");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = PrivateForecastAccuracyResponse;
    ...
    /**
     * Callback function to receive the result of the v1PrivateForecastTimeSymbolIntervalPeriodGet operation.
     * @callback module:api/PrivateApi~v1PrivateForecastTimeSymbolIntervalPeriodGetCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PrivateForecastTimeResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.cookie e.g. csrf=b1820141-1bad-4a9c-93c0-52022817ce89
     * @param {String} opts.xCsrf e.g. b1820141-1bad-4a9c-93c0-52022817ce89
     * @param {module:api/PrivateApi~v1PrivateForecastTimeSymbolIntervalPeriodGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PrivateForecastTimeResponse}
     */
    this.v1PrivateForecastTimeSymbolIntervalPeriodGet = function(symbol, interval, period, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'symbol' is set
      if (symbol === undefined || symbol === null) {
        throw new Error("Missing the required parameter 'symbol' when calling v1PrivateForecastTimeSymbolIntervalPeriodGet");
      }

      // verify the required parameter 'interval' is set
      if (interval === undefined || interval === null) {
        throw new Error("Missing the required parameter 'interval' when calling v1PrivateForecastTimeSymbolIntervalPeriodGet");
      }

      // verify the required parameter 'period' is set
      if (period === undefined || period === null) {
        throw new Error("Missing the required parameter 'period' when calling v1PrivateForecastTimeSymbolIntervalPeriodGet");
      }
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = PrivateForecastTimeResponse;
