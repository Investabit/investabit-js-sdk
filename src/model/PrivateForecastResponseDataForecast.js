...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CryptoWeather.PrivateForecastResponseDataForecast = factory(root.CryptoWeather.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PrivateForecastResponseDataForecast model module.
   * @module model/PrivateForecastResponseDataForecast
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PrivateForecastResponseDataForecast</code>.
   * @alias module:model/PrivateForecastResponseDataForecast
   * @class
   ...
   */
  var exports = function(timeStart, timeEnd, low, weightedPrice, high, confidence, changeUsd, changePct) {
  ...
  /**
   * Constructs a <code>PrivateForecastResponseDataForecast</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PrivateForecastResponseDataForecast} obj Optional instance to populate.
   * @return {module:model/PrivateForecastResponseDataForecast} The populated <code>PrivateForecastResponseDataForecast</code> instance.
   */
