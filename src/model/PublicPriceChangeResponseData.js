...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CryptoWeather.PublicPriceChangeResponseData = factory(root.CryptoWeather.ApiClient, root.CryptoWeather.PublicPriceChangeResponseDataPriceChange);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('price_change'))
        obj.priceChange = ApiClient.convertToType(data['price_change'], [PublicPriceChangeResponseDataPriceChange]);
    }
    return obj;
  }

  /**
   * @member {Array.<module:model/PublicPriceChangeResponseDataPriceChange>} priceChange
   */
